...
#[test]
#[ignore = "HDF5 version-specific behavior - split driver returns Multi on some versions"]
...
#[test]
#[ignore = "HDF5 version-specific validation - eviction settings differ between versions"]
...
fn test_dcpl_fill_value() -> hdf5::Result<()> {
    ...
    // Note: Complex fill value test with custom struct removed - requires hdf5_derive
